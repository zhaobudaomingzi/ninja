...
```shell
wget https://github.com/gngpp/ninja/releases/download/v0.9.11/ninja-0.9.11-x86_64-unknown-linux-musl.tar.gz
tar -xf ninja-0.9.11-x86_64-unknown-linux-musl.tar.gz
mv ./ninja /bin/ninja
./ninja run
...
```shell
wget https://github.com/gngpp/ninja/releases/download/v0.9.11/ninja_0.9.11_aarch64_generic.ipk
wget https://github.com/gngpp/ninja/releases/download/v0.9.11/luci-app-ninja_1.1.6-1_all.ipk
wget https://github.com/gngpp/ninja/releases/download/v0.9.11/luci-i18n-ninja-zh-cn_1.1.6-1_all.ipk

opkg install ninja_0.9.11_aarch64_generic.ipk
