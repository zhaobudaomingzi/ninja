...
const LOGIN_PAGE: &'static str = include_str!("../../../../templates/har/login.html");
const UPLOAD_PAGE: &'static str = include_str!("../../../../templates/har/upload.html");
const SUCCESS_PAGE: &'static str = include_str!("../../../../templates/har/success.html");
const ERROR_PAGE: &'static str = include_str!("../../../../templates/har/error.html");
